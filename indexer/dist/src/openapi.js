...
export const openApiDocument = {
    ...
    paths: {
        ...
        "/ready": { get: ok({ type: "object", properties: { status: { type: "string", enum: ["ready", "not_ready"] }, checks: { type: "object", properties: { database: { type: "boolean" }, migrations: { type: "boolean" }, rpc: { type: "boolean" } } }, migrationsApplied: { type: "integer" }, expectedMigrations: { type: ["integer", "null"] }, missingMigrations: { type: "array", items: { type: "string" } }, rpcConfigured: { type: "boolean" }, rpcReachable: { type: "boolean" }, dataSource: { type: "string", const: "indexer" }, isMock: { type: "boolean", const: false } } }) },
