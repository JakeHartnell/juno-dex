...
export interface IncentivesReadOnlyInterface {
...
export class IncentivesQueryClient implements IncentivesReadOnlyInterface {
...
export interface IncentivesInterface {
  contractAddress: string;
  sender: string;
  setupPools: ({
    pools
  ...
  incentivizeMany: (fee_?: number | StdFee | "auto", memo_?: string, funds_?: Coin[]) => Promise<any>;
  ...
  deactivateBlockedPools: (fee_?: number | StdFee | "auto", memo_?: string, funds_?: Coin[]) => Promise<any>;
  proposeNewOwner: ({
    expiresIn,
    owner
  }: {
...
export class IncentivesClient implements IncentivesInterface {
  ...
  incentivizeMany = async (fee_: number | StdFee | "auto" = "auto", memo_?: string, funds_?: Coin[]): Promise<any> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      incentivize_many: {}
    }, fee_, memo_, funds_);
  };
  ...
  deactivateBlockedPools = async (fee_: number | StdFee | "auto" = "auto", memo_?: string, funds_?: Coin[]): Promise<any> => {
    return await this.client.execute(this.sender, this.contractAddress, {
